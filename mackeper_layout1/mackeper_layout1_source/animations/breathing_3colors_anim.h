...
RGB_MATRIX_EFFECT(breathing_3colors_anim)
#ifdef ENABLE_RGB_MATRIX_BREATHING_3COLORS

static uint8_t g_s_can_change_color = 0;
static uint8_t g_s_current = 0;
static uint8_t g_s_int[3] = {1, 0, 0};

static bool breathing_3colors_anim(effect_params_t *params) {
...
#endif // ENABLE_RGB_MATRIX_BREATHING_3COLORS
